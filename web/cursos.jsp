            ...
            <%
                out.print("<table style='width: 100%;' id='tablalistado'>"
                        + "<tr style='background-color:#ffcc66'>"
                            ...
                            +"<td colspan=2 style='width: 20%' align='center'>Anio Curricular</td>"
                            +"<td colspan=2 style='width: 20%' align='center'>Jefatura</td>");
                ...
                for (  CursoBedelia p : mp.getCursos().values()){
                       ...
                       out.print("</td>");
                        ...
                        out.print("<td style='width: 5%' align='center'><a href='cursos?elim=1&id="+p.getId()+"'><img src='images/eliminar.png' width='60%' /></a></td>"
                       +"</tr>");
                }
                out.print("</table>");
            %> 
